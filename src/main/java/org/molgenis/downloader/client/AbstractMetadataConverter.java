...
abstract class AbstractMetadataConverter implements MetadataConverter {
  ...
  void setInteger(
      final Map<String, String> data, final String field, final Consumer<Integer> consumer) {
    setData(data, field, (s -> !s.isEmpty()), Integer::valueOf, consumer);
  }

  void setBoolean(
      final Map<String, String> data, final String field, final Consumer<Boolean> consumer) {
    setData(data, field, Boolean::valueOf, consumer);
  }

  void setString(
      final Map<String, String> data, final String field, final Consumer<String> consumer) {
