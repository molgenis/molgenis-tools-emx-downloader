...
public class NameUtils {
  public static String getPackageFullName(Package pack, MolgenisVersion version) {
    ...
    return pack.getParent() == null
        ? name
        : NameUtils.getPackageFullName(pack.getParent(), version) + "_" + name;
  }

  public static String getEntityShortName(Entity entity, MolgenisVersion version) {
    String prefix =
        entity.getPackage() == null
            ? ""
            : NameUtils.getPackageFullName(entity.getPackage(), version) + "_";
