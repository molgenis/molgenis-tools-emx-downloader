...
public class EMXEntitySerializerV3 implements EntitySerializer<Entity> {
  private static final String[] FIELDS = {
    "name", "package", "extends", "abstract", "backend", "tags", "label", "description"
  };
  ...
  public List<String> serialize(final Entity entity) {
    ...
    result.add(
        Optional.ofNullable(entity.getBackend())
            .filter(
                backend -> !(backend.equals(Backend.MYSQL) || backend.equals(Backend.POSTGRESQL)))
