...
public class MolgenisV92MetadataConverterTest {
  private MolgenisV92MetadataConverter converter;
  private WriteableMetadataRepository metadataRepository;

  @BeforeClass
  public void setup() {
    metadataRepository = mock(WriteableMetadataRepository.class);
    converter = new MolgenisV92MetadataConverter(metadataRepository);
  }
