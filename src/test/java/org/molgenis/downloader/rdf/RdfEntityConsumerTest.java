...
public class RdfEntityConsumerTest {
  ...
  public Iterator<Object[]> provideConversionData() {
    ...
    { // BOOL
      ...
      provider.add(
          new Object[] {
            createAttribute("boolAttr", BOOL),
            createData("boolAttr", "true"),
    ...
    { // DATE
      ...
      provider.add(
          new Object[] {
            createAttribute("dateAttr", DATE),
            createData("dateAttr", "2014-08-01"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // DATE_TIME
      Literal object =
          valueFactory.createLiteral(
              DATATYPE_FACTORY.newXMLGregorianCalendar(
                  Instant.parse("1985-08-12T08:12:13Z").toString()));
      provider.add(
          new Object[] {
            createAttribute("datetimeAttr", DATE_TIME),
    ...
    { // DECIMAL
      ...
      provider.add(
          new Object[] {
            createAttribute("decimalAttr", DECIMAL),
            createData("decimalAttr", "1.23"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // LONG
      ...
      provider.add(
          new Object[] {
            createAttribute("longAttr", LONG),
            createData("longAttr", "2147483648"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // INT
      ...
      provider.add(
          new Object[] {
            createAttribute("intAttr", INT),
            createData("intAttr", "8"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // ENUM, HTML, TEXT, SCRIPT
      ...
      provider.add(
          new Object[] {
            createAttribute("enumAttr", ENUM),
            createData("enumAttr", "enum"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // STRING
      ...
      provider.add(
          new Object[] {
            createAttribute("stringAttr", STRING),
            createData("stringAttr", "test"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // EMAIL
      ...
      provider.add(
          new Object[] {
            createAttribute("emailAttr", EMAIL),
            createData("emailAttr", "test@molgenis.nl"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // HYPERLINK
      ...
      provider.add(
          new Object[] {
            createAttribute("hyperlinkAttr", HYPERLINK),
            createData("hyperlinkAttr", "http://test.nl"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // XREF
      ...
      provider.add(
          new Object[] {
            createRefAttribute("xrefAttr", XREF),
            createData("xrefAttr", "1"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // CATEGORICAL
      ...
      provider.add(
          new Object[] {
            createRefAttribute("categoricalAttr", CATEGORICAL),
            createData("categoricalAttr", "1"),
            createSingleStatement(subject, predicate, object)
          });
    }
    { // MREF
      ...
      provider.add(
          new Object[] {
            createRefAttribute("mrefAttr", MREF),
            createData("mrefAttr", "1,2,3"),
    ...
    { // CATEGORICAL_MREF
      ...
      provider.add(
          new Object[] {
            createRefAttribute("categoricalmrefAttr", CATEGORICAL_MREF),
  ...
  public void testDataConversion(
      Attribute attribute, Map<String, String> data, List<Statement> expectedStatements) {
  ...
  private List<Statement> runEntityConsumer(Map<String, String> data) {
    ...
    EntityConsumer rdfEntityConsumer =
        new RdfEntityConsumer(entityType, valueFactory, actualStatements::add, rdfConfig);
