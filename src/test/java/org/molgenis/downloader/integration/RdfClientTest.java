...
public class RdfClientTest
{
	...
	public void rdfITTest() throws Exception
	{
		...
		rdfClient.export(outputFile, Collections.singletonList("org_molgenis_test_TypeTest"), 100, VERSION_2);

		String actual = FileUtils.readFileToString(outputFile, "utf-8");
		String expected = IOUtils.toString(getClass().getResourceAsStream("/integration/export.ttl"), "utf-8");
